...
function AppointmentForm() {
  ...
  return (
    ...
    <div className='bg-gradient-to-t from-gray-900 via-purple-900 to-violet-600 min-h-full'>
        <Nav/>  
        <div className=" signup-container flex-col text-lg">
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-3 gap-4 content-center">
                ...
                <button className="w-4/5 mx-auto my-10 py-2" type="submit">Check Condition</button>
            </form>  
        </div>
    </div>
  );
